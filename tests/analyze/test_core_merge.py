...
def test_merge_consecutive_segments_merges_expected_rows():
    df = pd.DataFrame(
        [
            {"input": "file_a.wav", "species_name": "species_alpha", "start_time": 0.0, "end_time": 2.0, "confidence": 0.4},
            {"input": "file_a.wav", "species_name": "species_alpha", "start_time": 2.0, "end_time": 4.0, "confidence": 0.6},
            {"input": "file_a.wav", "species_name": "species_alpha", "start_time": 5.0, "end_time": 6.0, "confidence": 0.8},
            {"input": "file_b.wav", "species_name": "species_beta", "start_time": 0.0, "end_time": 1.0, "confidence": 0.5},
            {"input": "file_b.wav", "species_name": "species_beta", "start_time": 1.0, "end_time": 2.0, "confidence": 0.7},
        ]
    )
...
def test_merge_consecutive_segments_requires_full_window():
    df = pd.DataFrame(
        [
            {"input": "file.wav", "species_name": "species", "start_time": 0.0, "end_time": 1.0, "confidence": 0.25},
            {"input": "file.wav", "species_name": "species", "start_time": 1.0, "end_time": 2.0, "confidence": 0.75},
            {"input": "file.wav", "species_name": "species", "start_time": 2.0, "end_time": 3.0, "confidence": 0.5},
        ]
    )
...
def test_merge_consecutive_segments_handles_float16_time_columns():
    df = pd.DataFrame(
        [
            {"input": "file.wav", "species_name": "species", "start_time": 0.0, "end_time": 1.0, "confidence": 0.1},
            {"input": "file.wav", "species_name": "species", "start_time": 1.0, "end_time": 2.0, "confidence": 0.3},
        ]
    )
...
def test_merge_consecutive_segments_no_merge_when_merge_value_is_one():
    df = pd.DataFrame(
        [
            {"input": "file.wav", "species_name": "species", "start_time": 0.0, "end_time": 1.0, "confidence": 0.2},
            {"input": "file.wav", "species_name": "species", "start_time": 1.0, "end_time": 2.0, "confidence": 0.3},
        ]
    )
...
def test_merge_consecutive_segments_returns_empty_for_empty_dataframe():
    df = pd.DataFrame(columns=["input", "species_name", "start_time", "end_time", "confidence"])
...
def test_merge_consecutive_segments_raises_for_non_numeric_time_values():
    df = pd.DataFrame(
        [
            {"input": "file.wav", "species_name": "species", "start_time": "a", "end_time": "b", "confidence": 0.1},
            {"input": "file.wav", "species_name": "species", "start_time": "c", "end_time": "d", "confidence": 0.2},
        ]
    )
